      ...
      <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm">
        <CardContent className="p-8">
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Prize/Amount</label>
                  <Input
            ...
            <TabsContent value="details" className="space-y-6">
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700">About This Opportunity</label>
                <Textarea
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-slate-700">What You'll Get</label>
                <Textarea
            ...
            <TabsContent value="dates" className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Program Start Date</label>
                  <Input
                    type="date"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Program End Date</label>
                  <Input
                    type="date"
            ...
            <TabsContent value="requirements" className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Age Eligibility</label>
                  <Input
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-slate-700">Language Requirements</label>
                  <Input
          ...
          <div className="flex justify-end space-x-4 pt-8 mt-8 border-t border-slate-200">
            <Button variant="outline" onClick={handleCancel} disabled={isSubmitting} className="px-6 bg-transparent">
              Cancel
            </Button>
            <Button
